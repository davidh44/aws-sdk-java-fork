        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("DeliveredTimestamp", targetDepth)) {
                    context.nextToken();
                    receipt.setDeliveredTimestamp(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("ReadTimestamp", targetDepth)) {
                    context.nextToken();
                    receipt.setReadTimestamp(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("RecipientParticipantId", targetDepth)) {
                    context.nextToken();
                    receipt.setRecipientParticipantId(context.getUnmarshaller(String.class).unmarshall(context));
                }
