...
public class RecommendationDataMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> RDSENGINE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("RdsEngine").build();
    ...
    public void marshall(RecommendationData recommendationData, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(recommendationData.getRdsEngine(), RDSENGINE_BINDING);
        } catch (Exception e) {
