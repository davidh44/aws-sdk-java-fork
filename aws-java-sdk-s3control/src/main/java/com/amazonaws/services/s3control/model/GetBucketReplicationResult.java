...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/s3control-2018-08-20/GetBucketReplication" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetBucketReplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.services.s3control.S3ControlResponseMetadata> implements
        Serializable, Cloneable {

    /**
     * <p>
     * A container for one or more replication rules. A replication configuration must have at least one rule and you
     * can add up to 100 rules. The maximum size of a replication configuration is 128 KB.
     * </p>
     */
     ...
     *        you can add up to 100 rules. The maximum size of a replication configuration is 128 KB.
     */
     ...
     *         and you can add up to 100 rules. The maximum size of a replication configuration is 128 KB.
     */
    ...
    public GetBucketReplicationResult withReplicationConfiguration(ReplicationConfiguration replicationConfiguration) {
    ...
    @Override
    public GetBucketReplicationResult clone() {
        try {
            return (GetBucketReplicationResult) super.clone();
