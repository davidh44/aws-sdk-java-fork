...
/**
 * GetMultiRegionAccessPointRoutesResult StAX Unmarshaller
 */
...
public class GetMultiRegionAccessPointRoutesResultStaxUnmarshaller implements Unmarshaller<GetMultiRegionAccessPointRoutesResult, StaxUnmarshallerContext> {
    ...
    public GetMultiRegionAccessPointRoutesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Mrap", targetDepth)) {
                    getMultiRegionAccessPointRoutesResult.setMrap(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Routes", targetDepth)) {
                    getMultiRegionAccessPointRoutesResult.withRoutes(new ArrayList<MultiRegionAccessPointRoute>());
                    continue;
                }

                if (context.testExpression("Routes/Route", targetDepth)) {
                    getMultiRegionAccessPointRoutesResult.withRoutes(MultiRegionAccessPointRouteStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
