...
public class DeleteBucketReplicationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Web Services account ID of the Outposts bucket to delete the replication configuration for.
     */
    ...
    public DeleteBucketReplicationRequest withAccountId(String accountId) {
     ...
     * 
     * @param bucket
     *        Specifies the S3 on Outposts bucket to delete the replication configuration for.</p>
     *        <p>
     *        For using this parameter with Amazon S3 on Outposts with the REST API, you must specify the name and the
     *        x-amz-outpost-id as well.
     *        </p>
     ...
     * </p>
     * 
     * @return Specifies the S3 on Outposts bucket to delete the replication configuration for.</p>
     *         <p>
     *         For using this parameter with Amazon S3 on Outposts with the REST API, you must specify the name and the
     *         x-amz-outpost-id as well.
     *         </p>
    ...
    @Override
    public DeleteBucketReplicationRequest clone() {
        return (DeleteBucketReplicationRequest) super.clone();
    }
