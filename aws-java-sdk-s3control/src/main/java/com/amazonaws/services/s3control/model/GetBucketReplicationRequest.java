...
public class GetBucketReplicationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetBucketReplicationRequest withAccountId(String accountId) {
     ...
     * 
     * @param bucket
     *        Specifies the bucket to get the replication information for.</p>
     *        <p>
     *        For using this parameter with Amazon S3 on Outposts with the REST API, you must specify the name and the
     *        x-amz-outpost-id as well.
     *        </p>
     ...
     * </p>
     * 
     * @return Specifies the bucket to get the replication information for.</p>
     *         <p>
     *         For using this parameter with Amazon S3 on Outposts with the REST API, you must specify the name and the
     *         x-amz-outpost-id as well.
     *         </p>
    ...
    @Override
    public GetBucketReplicationRequest clone() {
        return (GetBucketReplicationRequest) super.clone();
    }
