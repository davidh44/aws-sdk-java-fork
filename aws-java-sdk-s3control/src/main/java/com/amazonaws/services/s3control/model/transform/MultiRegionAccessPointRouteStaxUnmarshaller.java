...
/**
 * MultiRegionAccessPointRoute StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MultiRegionAccessPointRouteStaxUnmarshaller implements Unmarshaller<MultiRegionAccessPointRoute, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Bucket", targetDepth)) {
                    multiRegionAccessPointRoute.setBucket(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("Region", targetDepth)) {
                    multiRegionAccessPointRoute.setRegion(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("TrafficDialPercentage", targetDepth)) {
                    multiRegionAccessPointRoute.setTrafficDialPercentage(IntegerStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
