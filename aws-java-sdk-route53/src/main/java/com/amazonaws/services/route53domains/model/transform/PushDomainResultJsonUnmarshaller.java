...
/**
 * PushDomainResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PushDomainResultJsonUnmarshaller implements Unmarshaller<PushDomainResult, JsonUnmarshallerContext> {

    public PushDomainResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PushDomainResult pushDomainResult = new PushDomainResult();

        return pushDomainResult;
    }
