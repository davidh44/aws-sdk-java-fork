...
public class DisassociateDelegationSignerFromDomainResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DisassociateDelegationSignerFromDomainResult == false)
            return false;
        DisassociateDelegationSignerFromDomainResult other = (DisassociateDelegationSignerFromDomainResult) obj;
    ...
    public DisassociateDelegationSignerFromDomainResult clone() {
        try {
            return (DisassociateDelegationSignerFromDomainResult) super.clone();
