...
public class FormCTAMarshaller {
    ...
    private static final FormCTAMarshaller instance = new FormCTAMarshaller();

    public static FormCTAMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FormCTA formCTA, ProtocolMarshaller protocolMarshaller) {
