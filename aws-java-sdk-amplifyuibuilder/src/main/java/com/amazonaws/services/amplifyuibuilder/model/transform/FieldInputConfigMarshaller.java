...
public class FieldInputConfigMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> FILEUPLOADERCONFIG_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("fileUploaderConfig").build();
    ...
    public void marshall(FieldInputConfig fieldInputConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(fieldInputConfig.getFileUploaderConfig(), FILEUPLOADERCONFIG_BINDING);
        } catch (Exception e) {
