 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/UpdatePipeSourceSqsQueueParameters"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdatePipeSourceSqsQueueParameters implements Serializable, Cloneable, StructuredPojo {
    ...
    public UpdatePipeSourceSqsQueueParameters withBatchSize(Integer batchSize) {
    ...
    public UpdatePipeSourceSqsQueueParameters withMaximumBatchingWindowInSeconds(Integer maximumBatchingWindowInSeconds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePipeSourceSqsQueueParameters == false)
            return false;
        UpdatePipeSourceSqsQueueParameters other = (UpdatePipeSourceSqsQueueParameters) obj;
    ...
    @Override
    public UpdatePipeSourceSqsQueueParameters clone() {
        try {
            return (UpdatePipeSourceSqsQueueParameters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.UpdatePipeSourceSqsQueueParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
