 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/EcsResourceRequirement" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EcsResourceRequirement implements Serializable, Cloneable, StructuredPojo {
     ...
     *        The type of resource to assign to a container. The supported values are <code>GPU</code> or
     *        <code>InferenceAccelerator</code>.
     * @see EcsResourceRequirementType
     */
    ...
    public EcsResourceRequirement withType(String type) {
        setType(type);
        return this;
    }
    ...
    public EcsResourceRequirement withType(EcsResourceRequirementType type) {
     ...
     *        <code>deviceName</code> for an InferenceAccelerator specified in a task definition.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EcsResourceRequirement == false)
            return false;
        EcsResourceRequirement other = (EcsResourceRequirement) obj;
    ...
    @Override
    public EcsResourceRequirement clone() {
        try {
            return (EcsResourceRequirement) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.EcsResourceRequirementMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
