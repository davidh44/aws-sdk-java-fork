 ...
 * href="https://docs.aws.amazon.com/AmazonECS/latest/userguide/ecs-inference.html">Working with Amazon Elastic
 * Inference on Amazon ECS</a> in the <i>Amazon Elastic Container Service Developer Guide</i>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/EcsInferenceAcceleratorOverride"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EcsInferenceAcceleratorOverride implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EcsInferenceAcceleratorOverride == false)
            return false;
        EcsInferenceAcceleratorOverride other = (EcsInferenceAcceleratorOverride) obj;
    ...
    @Override
    public EcsInferenceAcceleratorOverride clone() {
        try {
            return (EcsInferenceAcceleratorOverride) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.EcsInferenceAcceleratorOverrideMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
