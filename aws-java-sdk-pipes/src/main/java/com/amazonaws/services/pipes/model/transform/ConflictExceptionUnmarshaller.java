...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.pipes.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.pipes.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.pipes.model.ConflictException conflictException = new com.amazonaws.services.pipes.model.ConflictException(null);
