...
public class ListLiveSourcesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListLiveSourcesRequest withMaxResults(Integer maxResults) {
    ...
    public ListLiveSourcesRequest withNextToken(String nextToken) {
    ...
    public ListLiveSourcesRequest withSourceLocationName(String sourceLocationName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLiveSourcesRequest == false)
            return false;
        ListLiveSourcesRequest other = (ListLiveSourcesRequest) obj;
    ...
    @Override
    public ListLiveSourcesRequest clone() {
        return (ListLiveSourcesRequest) super.clone();
    }
