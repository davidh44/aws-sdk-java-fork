...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/mediatailor-2018-04-23/CreateLiveSource" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CreateLiveSourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateLiveSourceResult withCreationTime(java.util.Date creationTime) {
    ...
    public CreateLiveSourceResult withHttpPackageConfigurations(HttpPackageConfiguration... httpPackageConfigurations) {
    ...
    public CreateLiveSourceResult withHttpPackageConfigurations(java.util.Collection<HttpPackageConfiguration> httpPackageConfigurations) {
    ...
    public CreateLiveSourceResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public CreateLiveSourceResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateLiveSourceResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateLiveSourceResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateLiveSourceResult == false)
            return false;
        CreateLiveSourceResult other = (CreateLiveSourceResult) obj;
    ...
    public CreateLiveSourceResult clone() {
        try {
            return (CreateLiveSourceResult) super.clone();
