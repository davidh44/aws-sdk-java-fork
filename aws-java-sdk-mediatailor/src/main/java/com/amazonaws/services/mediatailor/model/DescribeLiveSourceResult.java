...
public class DescribeLiveSourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeLiveSourceResult withCreationTime(java.util.Date creationTime) {
    ...
    public DescribeLiveSourceResult withHttpPackageConfigurations(HttpPackageConfiguration... httpPackageConfigurations) {
    ...
    public DescribeLiveSourceResult withHttpPackageConfigurations(java.util.Collection<HttpPackageConfiguration> httpPackageConfigurations) {
    ...
    public DescribeLiveSourceResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public DescribeLiveSourceResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see DescribeLiveSourceResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public DescribeLiveSourceResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeLiveSourceResult == false)
            return false;
        DescribeLiveSourceResult other = (DescribeLiveSourceResult) obj;
    ...
    public DescribeLiveSourceResult clone() {
        try {
            return (DescribeLiveSourceResult) super.clone();
