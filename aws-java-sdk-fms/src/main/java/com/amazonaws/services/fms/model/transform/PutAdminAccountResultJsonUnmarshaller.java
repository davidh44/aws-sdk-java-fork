...
/**
 * PutAdminAccountResult JSON Unmarshaller
 */
...
public class PutAdminAccountResultJsonUnmarshaller implements Unmarshaller<PutAdminAccountResult, JsonUnmarshallerContext> {
    ...
    public PutAdminAccountResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutAdminAccountResult putAdminAccountResult = new PutAdminAccountResult();

        return putAdminAccountResult;
    }
