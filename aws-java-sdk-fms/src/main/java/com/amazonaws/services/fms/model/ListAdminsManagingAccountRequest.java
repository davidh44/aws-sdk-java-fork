...
public class ListAdminsManagingAccountRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAdminsManagingAccountRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListAdminsManagingAccountRequest == false)
            return false;
        ListAdminsManagingAccountRequest other = (ListAdminsManagingAccountRequest) obj;
    ...
    @Override
    public ListAdminsManagingAccountRequest clone() {
        return (ListAdminsManagingAccountRequest) super.clone();
    }
