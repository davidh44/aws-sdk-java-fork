...
import static com.amazonaws.retry.PredefinedBackoffStrategies.SDK_DEFAULT_MAX_BACKOFF_IN_MILLISECONDS;
import static com.amazonaws.retry.PredefinedBackoffStrategies.STANDARD_BACKOFF_STRATEGY;
import static com.amazonaws.retry.PredefinedBackoffStrategies.STANDARD_DEFAULT_BASE_DELAY_IN_MILLISECONDS;
    ...
    public static Collection<TestCase> parameters() throws Exception {
        return Arrays.asList(
            new TestCase().backoffStrategy(STANDARD_BACKOFF_STRATEGY)
                          .retriesAttempted(0)
                          .expectedMaxDelay(1000)
                          .expectedMedDelay(500)
                          .expectedMinDelay(1),
            new TestCase().backoffStrategy(STANDARD_BACKOFF_STRATEGY)
                          .retriesAttempted(1)
                          .expectedMaxDelay(2000)
                          .expectedMedDelay(1000)
                          .expectedMinDelay(1),
            new TestCase().backoffStrategy(STANDARD_BACKOFF_STRATEGY)
                          .retriesAttempted(2)
                          .expectedMaxDelay(4000)
                          .expectedMedDelay(2000)
                          .expectedMinDelay(1),
            new TestCase().backoffStrategy(STANDARD_BACKOFF_STRATEGY)
                          .retriesAttempted(3)
                          .expectedMaxDelay(8000)
                          .expectedMedDelay(4000)
                          .expectedMinDelay(1),
            new TestCase().backoffStrategy(STANDARD_BACKOFF_STRATEGY)
                          .retriesAttempted(4)
                          .expectedMaxDelay(16000)
                          .expectedMedDelay(8000)
                          .expectedMinDelay(1),
            new TestCase().backoffStrategy(STANDARD_BACKOFF_STRATEGY)
                          .retriesAttempted(5)
