...
/**
 * UpdateResourceProfileResult JSON Unmarshaller
 */
...
public class UpdateResourceProfileResultJsonUnmarshaller implements Unmarshaller<UpdateResourceProfileResult, JsonUnmarshallerContext> {
    ...
    public UpdateResourceProfileResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateResourceProfileResult updateResourceProfileResult = new UpdateResourceProfileResult();

        return updateResourceProfileResult;
    }
