...
public class PutClusterPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public PutClusterPolicyResult withCurrentVersion(String currentVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutClusterPolicyResult == false)
            return false;
        PutClusterPolicyResult other = (PutClusterPolicyResult) obj;
    ...
    @Override
    public PutClusterPolicyResult clone() {
        try {
