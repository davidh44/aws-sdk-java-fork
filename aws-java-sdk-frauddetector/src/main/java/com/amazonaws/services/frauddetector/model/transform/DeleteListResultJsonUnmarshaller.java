...
/**
 * DeleteListResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteListResultJsonUnmarshaller implements Unmarshaller<DeleteListResult, JsonUnmarshallerContext> {

    public DeleteListResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteListResult deleteListResult = new DeleteListResult();
