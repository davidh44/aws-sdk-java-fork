...
/**
 * UpdateListResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateListResultJsonUnmarshaller implements Unmarshaller<UpdateListResult, JsonUnmarshallerContext> {

    public UpdateListResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateListResult updateListResult = new UpdateListResult();
