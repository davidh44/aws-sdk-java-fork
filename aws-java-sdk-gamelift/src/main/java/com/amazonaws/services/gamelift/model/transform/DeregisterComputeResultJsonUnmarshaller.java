...
/**
 * DeregisterComputeResult JSON Unmarshaller
 */
...
public class DeregisterComputeResultJsonUnmarshaller implements Unmarshaller<DeregisterComputeResult, JsonUnmarshallerContext> {
    ...
    public DeregisterComputeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeregisterComputeResult deregisterComputeResult = new DeregisterComputeResult();
