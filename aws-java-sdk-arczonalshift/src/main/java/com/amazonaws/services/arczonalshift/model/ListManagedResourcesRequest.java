...
public class ListManagedResourcesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListManagedResourcesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListManagedResourcesRequest == false)
            return false;
        ListManagedResourcesRequest other = (ListManagedResourcesRequest) obj;
    ...
    @Override
    public ListManagedResourcesRequest clone() {
        return (ListManagedResourcesRequest) super.clone();
    }
