...
/**
 * DisassociateApplicationsResult JSON Unmarshaller
 */
...
public class DisassociateApplicationsResultJsonUnmarshaller implements Unmarshaller<DisassociateApplicationsResult, JsonUnmarshallerContext> {
    ...
    public DisassociateApplicationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DisassociateApplicationsResult disassociateApplicationsResult = new DisassociateApplicationsResult();
