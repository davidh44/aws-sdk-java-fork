...
public class UnarchiveApplicationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UnarchiveApplicationResult withApplicationAggregatedStatus(ApplicationAggregatedStatus applicationAggregatedStatus) {
    ...
    public UnarchiveApplicationResult withApplicationID(String applicationID) {
    ...
    public UnarchiveApplicationResult withArn(String arn) {
        setArn(arn);
        return this;
    }
    ...
    public UnarchiveApplicationResult withCreationDateTime(String creationDateTime) {
    ...
    public UnarchiveApplicationResult withDescription(String description) {
    ...
    public UnarchiveApplicationResult withIsArchived(Boolean isArchived) {
    ...
    public UnarchiveApplicationResult withLastModifiedDateTime(String lastModifiedDateTime) {
    ...
    public UnarchiveApplicationResult withName(String name) {
        setName(name);
        return this;
    }
    ...
    public UnarchiveApplicationResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UnarchiveApplicationResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UnarchiveApplicationResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public UnarchiveApplicationResult clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public UnarchiveApplicationResult withWaveID(String waveID) {
        setWaveID(waveID);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UnarchiveApplicationResult == false)
            return false;
        UnarchiveApplicationResult other = (UnarchiveApplicationResult) obj;
    ...
    @Override
    public UnarchiveApplicationResult clone() {
        try {
            return (UnarchiveApplicationResult) super.clone();
