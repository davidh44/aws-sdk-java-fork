...
/**
 * RemoveSourceServerActionResult JSON Unmarshaller
 */
...
public class RemoveSourceServerActionResultJsonUnmarshaller implements Unmarshaller<RemoveSourceServerActionResult, JsonUnmarshallerContext> {
    ...
    public RemoveSourceServerActionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        RemoveSourceServerActionResult removeSourceServerActionResult = new RemoveSourceServerActionResult();
