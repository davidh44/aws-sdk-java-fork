...
public class PutSourceServerActionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public PutSourceServerActionResult withParameters(java.util.Map<String, java.util.List<SsmParameterStoreParameter>> parameters) {
    ...
    public PutSourceServerActionResult addParametersEntry(String key, java.util.List<SsmParameterStoreParameter> value) {
