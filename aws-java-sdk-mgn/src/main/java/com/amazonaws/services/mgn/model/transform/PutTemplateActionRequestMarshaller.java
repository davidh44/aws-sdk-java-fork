...
/**
 * PutTemplateActionRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PutTemplateActionRequestMarshaller {
    ...
    private static final PutTemplateActionRequestMarshaller instance = new PutTemplateActionRequestMarshaller();

    public static PutTemplateActionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PutTemplateActionRequest putTemplateActionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(putTemplateActionRequest.getOrder(), ORDER_BINDING);
            protocolMarshaller.marshall(putTemplateActionRequest.getParameters(), PARAMETERS_BINDING);
            protocolMarshaller.marshall(putTemplateActionRequest.getTimeoutSeconds(), TIMEOUTSECONDS_BINDING);
        } catch (Exception e) {
