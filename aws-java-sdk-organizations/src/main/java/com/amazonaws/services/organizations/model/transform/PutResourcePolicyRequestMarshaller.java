...
public class PutResourcePolicyRequestMarshaller {
    ...
    public void marshall(PutResourcePolicyRequest putResourcePolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(putResourcePolicyRequest.getContent(), CONTENT_BINDING);
            protocolMarshaller.marshall(putResourcePolicyRequest.getTags(), TAGS_BINDING);
        } catch (Exception e) {
