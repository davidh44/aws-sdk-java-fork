...
/**
 * RequestInspectionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RequestInspectionMarshaller {
    ...
    private static final RequestInspectionMarshaller instance = new RequestInspectionMarshaller();

    public static RequestInspectionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RequestInspection requestInspection, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(requestInspection.getPayloadType(), PAYLOADTYPE_BINDING);
            protocolMarshaller.marshall(requestInspection.getUsernameField(), USERNAMEFIELD_BINDING);
            protocolMarshaller.marshall(requestInspection.getPasswordField(), PASSWORDFIELD_BINDING);
        } catch (Exception e) {
