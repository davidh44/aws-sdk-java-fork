        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("containerRuntime", targetDepth)) {
                    context.nextToken();
                    container.setContainerRuntime(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("id", targetDepth)) {
                    context.nextToken();
                    container.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("imagePrefix", targetDepth)) {
                    context.nextToken();
                    container.setImagePrefix(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("volumeMounts", targetDepth)) {
                    context.nextToken();
                    container.setVolumeMounts(new ListUnmarshaller<VolumeMount>(VolumeMountJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("securityContext", targetDepth)) {
                    context.nextToken();
                    container.setSecurityContext(SecurityContextJsonUnmarshaller.getInstance().unmarshall(context));
                }
