...
public class RdsDbUserDetailsMarshaller {
    ...
    private static final MarshallingInfo<String> SSL_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("ssl").build();
    private static final MarshallingInfo<String> AUTHMETHOD_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("authMethod").build();
