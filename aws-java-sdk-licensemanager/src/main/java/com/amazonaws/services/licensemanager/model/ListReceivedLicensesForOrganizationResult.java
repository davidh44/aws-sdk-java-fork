...
public class ListReceivedLicensesForOrganizationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return Lists the licenses the organization has received.
     */
    ...
    public ListReceivedLicensesForOrganizationResult withLicenses(GrantedLicense... licenses) {
    ...
    public ListReceivedLicensesForOrganizationResult withLicenses(java.util.Collection<GrantedLicense> licenses) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListReceivedLicensesForOrganizationResult == false)
            return false;
        ListReceivedLicensesForOrganizationResult other = (ListReceivedLicensesForOrganizationResult) obj;
    ...
    @Override
    public ListReceivedLicensesForOrganizationResult clone() {
        try {
            return (ListReceivedLicensesForOrganizationResult) super.clone();
