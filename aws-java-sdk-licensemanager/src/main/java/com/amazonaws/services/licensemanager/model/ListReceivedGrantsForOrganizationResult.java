...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/license-manager-2018-08-01/ListReceivedGrantsForOrganization"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListReceivedGrantsForOrganizationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return Lists the grants the organization has received.
     */
    ...
    public ListReceivedGrantsForOrganizationResult withGrants(Grant... grants) {
        if (this.grants == null) {
    ...
    public ListReceivedGrantsForOrganizationResult withGrants(java.util.Collection<Grant> grants) {
        setGrants(grants);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListReceivedGrantsForOrganizationResult == false)
            return false;
        ListReceivedGrantsForOrganizationResult other = (ListReceivedGrantsForOrganizationResult) obj;
    ...
    public ListReceivedGrantsForOrganizationResult clone() {
        try {
            return (ListReceivedGrantsForOrganizationResult) super.clone();
