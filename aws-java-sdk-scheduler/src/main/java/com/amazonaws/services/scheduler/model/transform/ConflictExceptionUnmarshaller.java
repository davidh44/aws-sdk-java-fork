...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.scheduler.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.scheduler.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.scheduler.model.ConflictException conflictException = new com.amazonaws.services.scheduler.model.ConflictException(null);
