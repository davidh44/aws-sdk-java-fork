...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.scheduler.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.scheduler.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.scheduler.model.ValidationException validationException = new com.amazonaws.services.scheduler.model.ValidationException(null);
