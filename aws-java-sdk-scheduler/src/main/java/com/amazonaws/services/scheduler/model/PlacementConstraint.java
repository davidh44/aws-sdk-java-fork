 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/scheduler-2021-06-30/PlacementConstraint" target="_top">AWS API
 *      Documentation</a>
 */
...
public class PlacementConstraint implements Serializable, Cloneable, StructuredPojo {
     ...
     * href="https://docs.aws.amazon.com/latest/developerguide/cluster-query-language.html">Cluster query language</a>
     ...
     *        A cluster query language expression to apply to the constraint. You cannot specify an expression if the
     *        constraint type is <code>distinctInstance</code>. For more information, see <a
     *        href="https://docs.aws.amazon.com/latest/developerguide/cluster-query-language.html">Cluster query
     *        language</a> in the <i>Amazon ECS Developer Guide</i>.
     */
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.scheduler.model.transform.PlacementConstraintMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
