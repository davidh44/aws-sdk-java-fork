...
/**
 * DeleteScheduleGroupResult JSON Unmarshaller
 */
...
public class DeleteScheduleGroupResultJsonUnmarshaller implements Unmarshaller<DeleteScheduleGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteScheduleGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteScheduleGroupResult deleteScheduleGroupResult = new DeleteScheduleGroupResult();
