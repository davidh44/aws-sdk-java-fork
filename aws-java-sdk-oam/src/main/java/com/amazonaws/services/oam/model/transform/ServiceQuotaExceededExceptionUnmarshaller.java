...
public class ServiceQuotaExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ServiceQuotaExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.oam.model.ServiceQuotaExceededException.class, "ServiceQuotaExceededException");
    }

    @Override
    public com.amazonaws.services.oam.model.ServiceQuotaExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.oam.model.ServiceQuotaExceededException serviceQuotaExceededException = new com.amazonaws.services.oam.model.ServiceQuotaExceededException(
                null);

        if (context.isStartOfDocument()) {
            if (context.getHeader("x-amzn-ErrorType") != null) {
                context.setCurrentHeader("x-amzn-ErrorType");
                serviceQuotaExceededException.setAmznErrorType(context.getUnmarshaller(String.class).unmarshall(context));
            }
        }
