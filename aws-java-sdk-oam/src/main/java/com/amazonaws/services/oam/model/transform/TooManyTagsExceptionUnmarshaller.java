...
public class TooManyTagsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private TooManyTagsExceptionUnmarshaller() {
        super(com.amazonaws.services.oam.model.TooManyTagsException.class, "TooManyTagsException");
    }

    @Override
    public com.amazonaws.services.oam.model.TooManyTagsException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.oam.model.TooManyTagsException tooManyTagsException = new com.amazonaws.services.oam.model.TooManyTagsException(null);
