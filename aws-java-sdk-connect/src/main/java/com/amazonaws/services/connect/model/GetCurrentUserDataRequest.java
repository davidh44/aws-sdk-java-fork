...
public class GetCurrentUserDataRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public GetCurrentUserDataRequest clone() {
        return (GetCurrentUserDataRequest) super.clone();
    }
