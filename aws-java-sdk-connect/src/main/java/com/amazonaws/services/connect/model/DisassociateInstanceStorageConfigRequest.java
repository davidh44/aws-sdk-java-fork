...
public class DisassociateInstanceStorageConfigRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DisassociateInstanceStorageConfigRequest withResourceType(InstanceStorageResourceType resourceType) {
    ...
    @Override
    public DisassociateInstanceStorageConfigRequest clone() {
        return (DisassociateInstanceStorageConfigRequest) super.clone();
    }
