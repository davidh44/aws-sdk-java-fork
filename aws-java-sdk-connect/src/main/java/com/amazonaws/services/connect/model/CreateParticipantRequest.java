...
public class CreateParticipantRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public String toString() {
        ...
        if (getParticipantDetails() != null)
            sb.append("ParticipantDetails: ").append(getParticipantDetails());
        sb.append("}");
        return sb.toString();
    }
    ...
    public CreateParticipantRequest clone() {
        return (CreateParticipantRequest) super.clone();
    }
