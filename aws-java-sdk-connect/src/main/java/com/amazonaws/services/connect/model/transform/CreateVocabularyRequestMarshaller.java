...
public class CreateVocabularyRequestMarshaller {
    ...
    public void marshall(CreateVocabularyRequest createVocabularyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createVocabularyRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createVocabularyRequest.getInstanceId(), INSTANCEID_BINDING);
            ...
            protocolMarshaller.marshall(createVocabularyRequest.getContent(), CONTENT_BINDING);
