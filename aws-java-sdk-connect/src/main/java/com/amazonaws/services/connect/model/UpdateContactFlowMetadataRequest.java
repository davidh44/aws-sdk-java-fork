...
public class UpdateContactFlowMetadataRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public UpdateContactFlowMetadataRequest clone() {
