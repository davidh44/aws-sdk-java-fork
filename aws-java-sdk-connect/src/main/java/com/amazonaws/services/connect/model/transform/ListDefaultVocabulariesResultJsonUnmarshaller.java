...
/**
 * ListDefaultVocabulariesResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ListDefaultVocabulariesResultJsonUnmarshaller implements Unmarshaller<ListDefaultVocabulariesResult, JsonUnmarshallerContext> {

    public ListDefaultVocabulariesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
