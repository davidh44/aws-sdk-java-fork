...
/**
 * LivenessOutputConfigMarshaller
 */
...
public class LivenessOutputConfigMarshaller {
    ...
    public void marshall(LivenessOutputConfig livenessOutputConfig, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(livenessOutputConfig.getS3Bucket(), S3BUCKET_BINDING);
            protocolMarshaller.marshall(livenessOutputConfig.getS3KeyPrefix(), S3KEYPREFIX_BINDING);
        } catch (Exception e) {
