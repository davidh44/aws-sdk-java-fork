...
public class GetFaceLivenessSessionResultsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {

    /**
     * <p>
     * A unique 128-bit UUID. This is used to uniquely identify the session and also acts as an idempotency token for
     * all operations associated with the session.
     * </p>
     */
     ...
     * </p>
     * 
     * @return A unique 128-bit UUID. This is used to uniquely identify the session and also acts as an idempotency
    ...
    public GetFaceLivenessSessionResultsRequest clone() {
        return (GetFaceLivenessSessionResultsRequest) super.clone();
    }
