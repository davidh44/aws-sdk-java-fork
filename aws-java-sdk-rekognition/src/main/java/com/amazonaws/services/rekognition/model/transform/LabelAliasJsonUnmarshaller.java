...
/**
 * LabelAlias JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LabelAliasJsonUnmarshaller implements Unmarshaller<LabelAlias, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Name", targetDepth)) {
                    context.nextToken();
                    labelAlias.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
