...
public class PutFeedbackRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> FEEDBACK_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("feedback").build();
    ...
    public void marshall(PutFeedbackRequest putFeedbackRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(putFeedbackRequest.getFeedback(), FEEDBACK_BINDING);
