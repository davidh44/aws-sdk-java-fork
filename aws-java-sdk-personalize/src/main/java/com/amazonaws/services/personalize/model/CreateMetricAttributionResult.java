...
public class CreateMetricAttributionResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) for the new metric attribution.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateMetricAttributionResult == false)
            return false;
        CreateMetricAttributionResult other = (CreateMetricAttributionResult) obj;
    ...
    @Override
    public CreateMetricAttributionResult clone() {
        try {
            return (CreateMetricAttributionResult) super.clone();
