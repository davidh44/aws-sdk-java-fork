...
public class ListMetricAttributionMetricsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public ListMetricAttributionMetricsResult withMetrics(MetricAttribute... metrics) {
    ...
    public ListMetricAttributionMetricsResult withMetrics(java.util.Collection<MetricAttribute> metrics) {
        setMetrics(metrics);
        return this;
    }
    ...
    public ListMetricAttributionMetricsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListMetricAttributionMetricsResult == false)
            return false;
        ListMetricAttributionMetricsResult other = (ListMetricAttributionMetricsResult) obj;
    ...
    public ListMetricAttributionMetricsResult clone() {
        try {
            return (ListMetricAttributionMetricsResult) super.clone();
