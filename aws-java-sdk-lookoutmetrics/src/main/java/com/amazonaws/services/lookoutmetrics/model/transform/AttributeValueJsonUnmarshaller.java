        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("B", targetDepth)) {
                    context.nextToken();
                    attributeValue.setB(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("BS", targetDepth)) {
                    context.nextToken();
                    attributeValue.setBS(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
