...
public class GetTaskProtectionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetTaskProtectionRequest withTasks(java.util.Collection<String> tasks) {
        setTasks(tasks);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTaskProtectionRequest == false)
            return false;
        GetTaskProtectionRequest other = (GetTaskProtectionRequest) obj;
