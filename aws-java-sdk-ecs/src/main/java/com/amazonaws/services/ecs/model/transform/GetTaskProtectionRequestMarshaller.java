...
public class GetTaskProtectionRequestMarshaller {
    ...
    private static final GetTaskProtectionRequestMarshaller instance = new GetTaskProtectionRequestMarshaller();

    public static GetTaskProtectionRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetTaskProtectionRequest getTaskProtectionRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getTaskProtectionRequest.getCluster(), CLUSTER_BINDING);
            protocolMarshaller.marshall(getTaskProtectionRequest.getTasks(), TASKS_BINDING);
        } catch (Exception e) {
