...
public class DescribeMapRunRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeMapRunRequest withMapRunArn(String mapRunArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMapRunRequest == false)
            return false;
        DescribeMapRunRequest other = (DescribeMapRunRequest) obj;
    ...
    @Override
    public DescribeMapRunRequest clone() {
        return (DescribeMapRunRequest) super.clone();
    }
