...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.stepfunctions.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.stepfunctions.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.stepfunctions.model.ValidationException validationException = new com.amazonaws.services.stepfunctions.model.ValidationException(
                null);
