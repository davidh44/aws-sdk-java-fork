...
public class StageSummaryMarshaller {
    ...
    public void marshall(StageSummary stageSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(stageSummary.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(stageSummary.getGameKey(), GAMEKEY_BINDING);
            protocolMarshaller.marshall(stageSummary.getName(), NAME_BINDING);
            protocolMarshaller.marshall(stageSummary.getState(), STATE_BINDING);
