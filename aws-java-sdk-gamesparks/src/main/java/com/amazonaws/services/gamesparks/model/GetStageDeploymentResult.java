...
public class GetStageDeploymentResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Properties that provide details of the stage deployment.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetStageDeploymentResult == false)
            return false;
        GetStageDeploymentResult other = (GetStageDeploymentResult) obj;
    ...
    @Override
    public GetStageDeploymentResult clone() {
        try {
            return (GetStageDeploymentResult) super.clone();
