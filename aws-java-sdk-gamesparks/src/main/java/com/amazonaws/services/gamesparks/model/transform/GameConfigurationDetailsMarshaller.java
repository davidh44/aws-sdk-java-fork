...
/**
 * GameConfigurationDetailsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GameConfigurationDetailsMarshaller {
    ...
    private static final GameConfigurationDetailsMarshaller instance = new GameConfigurationDetailsMarshaller();

    public static GameConfigurationDetailsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GameConfigurationDetails gameConfigurationDetails, ProtocolMarshaller protocolMarshaller) {

        if (gameConfigurationDetails == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(gameConfigurationDetails.getCreated(), CREATED_BINDING);
            protocolMarshaller.marshall(gameConfigurationDetails.getLastUpdated(), LASTUPDATED_BINDING);
            protocolMarshaller.marshall(gameConfigurationDetails.getSections(), SECTIONS_BINDING);
        } catch (Exception e) {
