...
public class CreateStageRequestMarshaller {
    ...
    public void marshall(CreateStageRequest createStageRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createStageRequest.getClientToken(), CLIENTTOKEN_BINDING);
            protocolMarshaller.marshall(createStageRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(createStageRequest.getGameName(), GAMENAME_BINDING);
            protocolMarshaller.marshall(createStageRequest.getRole(), ROLE_BINDING);
