...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.gamesparks.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.gamesparks.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.gamesparks.model.ConflictException conflictException = new com.amazonaws.services.gamesparks.model.ConflictException(null);
