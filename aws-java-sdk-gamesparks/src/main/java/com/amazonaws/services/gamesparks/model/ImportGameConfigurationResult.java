...
public class ImportGameConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportGameConfigurationResult == false)
            return false;
        ImportGameConfigurationResult other = (ImportGameConfigurationResult) obj;
    ...
    @Override
    public ImportGameConfigurationResult clone() {
        try {
            return (ImportGameConfigurationResult) super.clone();
