...
/**
 * GeneratedCodeJobDetails JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GeneratedCodeJobDetailsJsonUnmarshaller implements Unmarshaller<GeneratedCodeJobDetails, JsonUnmarshallerContext> {

    public GeneratedCodeJobDetails unmarshall(JsonUnmarshallerContext context) throws Exception {
        GeneratedCodeJobDetails generatedCodeJobDetails = new GeneratedCodeJobDetails();
    ...
    private static GeneratedCodeJobDetailsJsonUnmarshaller instance;

    public static GeneratedCodeJobDetailsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GeneratedCodeJobDetailsJsonUnmarshaller();
        return instance;
    }
}
