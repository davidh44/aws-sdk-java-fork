...
public class CreateEphemerisResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateEphemerisResult withEphemerisId(String ephemerisId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateEphemerisResult == false)
            return false;
        CreateEphemerisResult other = (CreateEphemerisResult) obj;
    ...
    @Override
    public CreateEphemerisResult clone() {
        try {
            return (CreateEphemerisResult) super.clone();
