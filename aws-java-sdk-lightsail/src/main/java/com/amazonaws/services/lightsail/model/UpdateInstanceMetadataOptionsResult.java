...
public class UpdateInstanceMetadataOptionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateInstanceMetadataOptionsResult == false)
            return false;
        UpdateInstanceMetadataOptionsResult other = (UpdateInstanceMetadataOptionsResult) obj;
    ...
    @Override
    public UpdateInstanceMetadataOptionsResult clone() {
        try {
            return (UpdateInstanceMetadataOptionsResult) super.clone();
