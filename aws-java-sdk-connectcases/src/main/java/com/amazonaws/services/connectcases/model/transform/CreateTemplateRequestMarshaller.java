...
public class CreateTemplateRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> LAYOUTCONFIGURATION_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("layoutConfiguration").build();
    ...
    public void marshall(CreateTemplateRequest createTemplateRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createTemplateRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(createTemplateRequest.getDomainId(), DOMAINID_BINDING);
