...
public interface AWSSSO {
     ...
     * the administrator of the account. For more information, see <a
     * href="https://docs.aws.amazon.com/singlesignon/latest/userguide/useraccess.html#assignusers">Assign User
     * Access</a> in the <i>Amazon Web Services SSO User Guide</i>. This operation returns a paginated response.
     * </p>
     * 
     ...
     * sets continue based on the duration configured in the permission set. For more information, see <a
     * href="https://docs.aws.amazon.com/singlesignon/latest/userguide/authconcept.html">User authentications</a> in the
     * <i>Amazon Web Services SSO User Guide</i>.
     * </p>
     * </note>
     * 
     * @param logoutRequest
