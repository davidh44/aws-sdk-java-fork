...
public class BatchGetAssetPropertyAggregatesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     */
    private java.util.List<BatchGetAssetPropertyAggregatesErrorEntry> errorEntries;
    /**
     * <p>
     ...
     * </p>
     */
    private java.util.List<BatchGetAssetPropertyAggregatesSuccessEntry> successEntries;
    /**
     * <p>
     ...
     * </p>
     */
    private java.util.List<BatchGetAssetPropertyAggregatesSkippedEntry> skippedEntries;
    /**
     * <p>
    ...
    public java.util.List<BatchGetAssetPropertyAggregatesErrorEntry> getErrorEntries() {
        return errorEntries;
    }
    ...
    public void setErrorEntries(java.util.Collection<BatchGetAssetPropertyAggregatesErrorEntry> errorEntries) {
        if (errorEntries == null) {
            this.errorEntries = null;
            return;
        }

        this.errorEntries = new java.util.ArrayList<BatchGetAssetPropertyAggregatesErrorEntry>(errorEntries);
    }
    ...
    public BatchGetAssetPropertyAggregatesResult withErrorEntries(BatchGetAssetPropertyAggregatesErrorEntry... errorEntries) {
        if (this.errorEntries == null) {
            setErrorEntries(new java.util.ArrayList<BatchGetAssetPropertyAggregatesErrorEntry>(errorEntries.length));
        }
        for (BatchGetAssetPropertyAggregatesErrorEntry ele : errorEntries) {
    ...
    public BatchGetAssetPropertyAggregatesResult withErrorEntries(java.util.Collection<BatchGetAssetPropertyAggregatesErrorEntry> errorEntries) {
    ...
    public java.util.List<BatchGetAssetPropertyAggregatesSuccessEntry> getSuccessEntries() {
    ...
    public void setSuccessEntries(java.util.Collection<BatchGetAssetPropertyAggregatesSuccessEntry> successEntries) {
        if (successEntries == null) {
            this.successEntries = null;
            return;
        }

        this.successEntries = new java.util.ArrayList<BatchGetAssetPropertyAggregatesSuccessEntry>(successEntries);
    }
    ...
    public BatchGetAssetPropertyAggregatesResult withSuccessEntries(BatchGetAssetPropertyAggregatesSuccessEntry... successEntries) {
        if (this.successEntries == null) {
            setSuccessEntries(new java.util.ArrayList<BatchGetAssetPropertyAggregatesSuccessEntry>(successEntries.length));
        }
        for (BatchGetAssetPropertyAggregatesSuccessEntry ele : successEntries) {
    ...
    public BatchGetAssetPropertyAggregatesResult withSuccessEntries(java.util.Collection<BatchGetAssetPropertyAggregatesSuccessEntry> successEntries) {
    ...
    public java.util.List<BatchGetAssetPropertyAggregatesSkippedEntry> getSkippedEntries() {
    ...
    public void setSkippedEntries(java.util.Collection<BatchGetAssetPropertyAggregatesSkippedEntry> skippedEntries) {
        if (skippedEntries == null) {
            this.skippedEntries = null;
            return;
        }

        this.skippedEntries = new java.util.ArrayList<BatchGetAssetPropertyAggregatesSkippedEntry>(skippedEntries);
    }
    ...
    public BatchGetAssetPropertyAggregatesResult withSkippedEntries(BatchGetAssetPropertyAggregatesSkippedEntry... skippedEntries) {
        if (this.skippedEntries == null) {
            setSkippedEntries(new java.util.ArrayList<BatchGetAssetPropertyAggregatesSkippedEntry>(skippedEntries.length));
        }
        for (BatchGetAssetPropertyAggregatesSkippedEntry ele : skippedEntries) {
    ...
    public BatchGetAssetPropertyAggregatesResult withSkippedEntries(java.util.Collection<BatchGetAssetPropertyAggregatesSkippedEntry> skippedEntries) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGetAssetPropertyAggregatesResult == false)
            return false;
        BatchGetAssetPropertyAggregatesResult other = (BatchGetAssetPropertyAggregatesResult) obj;
    ...
    public BatchGetAssetPropertyAggregatesResult clone() {
        try {
            return (BatchGetAssetPropertyAggregatesResult) super.clone();
