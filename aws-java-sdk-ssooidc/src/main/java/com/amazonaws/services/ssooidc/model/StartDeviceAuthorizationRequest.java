...
public class StartDeviceAuthorizationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The unique identifier string for the client that is registered with Amazon Web Services SSO. This value should
     ...
     * portal</a> in the <i>Amazon Web Services SSO User Guide</i>.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The unique identifier string for the client that is registered with Amazon Web Services SSO. This value
     *         should come from the persisted result of the <a>RegisterClient</a> API operation.
     */
     ...
     *        access portal</a> in the <i>Amazon Web Services SSO User Guide</i>.
     */
