...
public class DescribeSNOMEDCTInferenceJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DescribeSNOMEDCTInferenceJobResult withComprehendMedicalAsyncJobProperties(ComprehendMedicalAsyncJobProperties comprehendMedicalAsyncJobProperties) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeSNOMEDCTInferenceJobResult == false)
            return false;
        DescribeSNOMEDCTInferenceJobResult other = (DescribeSNOMEDCTInferenceJobResult) obj;
    ...
    @Override
    public DescribeSNOMEDCTInferenceJobResult clone() {
        try {
            return (DescribeSNOMEDCTInferenceJobResult) super.clone();
