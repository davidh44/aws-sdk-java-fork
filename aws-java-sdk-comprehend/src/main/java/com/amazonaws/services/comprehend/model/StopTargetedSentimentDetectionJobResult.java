...
public class StopTargetedSentimentDetectionJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public StopTargetedSentimentDetectionJobResult clone() {
        try {
            return (StopTargetedSentimentDetectionJobResult) super.clone();
