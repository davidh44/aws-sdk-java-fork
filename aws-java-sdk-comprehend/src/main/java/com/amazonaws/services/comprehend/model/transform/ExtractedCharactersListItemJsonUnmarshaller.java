...
/**
 * ExtractedCharactersListItem JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExtractedCharactersListItemJsonUnmarshaller implements Unmarshaller<ExtractedCharactersListItem, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Page", targetDepth)) {
                    context.nextToken();
                    extractedCharactersListItem.setPage(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("Count", targetDepth)) {
                    context.nextToken();
                    extractedCharactersListItem.setCount(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
