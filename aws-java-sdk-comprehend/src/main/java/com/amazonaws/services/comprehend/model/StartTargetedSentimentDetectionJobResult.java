...
public class StartTargetedSentimentDetectionJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    @Override
    public StartTargetedSentimentDetectionJobResult clone() {
        try {
            return (StartTargetedSentimentDetectionJobResult) super.clone();
