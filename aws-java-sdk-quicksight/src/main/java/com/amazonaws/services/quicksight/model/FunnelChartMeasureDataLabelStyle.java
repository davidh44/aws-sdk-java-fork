...
public enum FunnelChartMeasureDataLabelStyle {
    ...
    private FunnelChartMeasureDataLabelStyle(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return FunnelChartMeasureDataLabelStyle corresponding to the value
     *
     * @throws IllegalArgumentException
     *         If the specified value does not map to one of the known values in this enum.
     */
    public static FunnelChartMeasureDataLabelStyle fromValue(String value) {
        if (value == null || "".equals(value)) {
            throw new IllegalArgumentException("Value cannot be null or empty!");
        }

        for (FunnelChartMeasureDataLabelStyle enumEntry : FunnelChartMeasureDataLabelStyle.values()) {
