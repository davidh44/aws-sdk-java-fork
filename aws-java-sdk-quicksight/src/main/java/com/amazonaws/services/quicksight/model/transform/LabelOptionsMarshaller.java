...
public class LabelOptionsMarshaller {
    ...
    public void marshall(LabelOptions labelOptions, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(labelOptions.getVisibility(), VISIBILITY_BINDING);
            protocolMarshaller.marshall(labelOptions.getFontConfiguration(), FONTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(labelOptions.getCustomLabel(), CUSTOMLABEL_BINDING);
        } catch (Exception e) {
