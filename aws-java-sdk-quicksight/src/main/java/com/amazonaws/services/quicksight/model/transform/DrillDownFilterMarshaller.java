...
/**
 * DrillDownFilterMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DrillDownFilterMarshaller {
    ...
    private static final DrillDownFilterMarshaller instance = new DrillDownFilterMarshaller();

    public static DrillDownFilterMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DrillDownFilter drillDownFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(drillDownFilter.getNumericEqualityFilter(), NUMERICEQUALITYFILTER_BINDING);
            protocolMarshaller.marshall(drillDownFilter.getCategoryFilter(), CATEGORYFILTER_BINDING);
            protocolMarshaller.marshall(drillDownFilter.getTimeRangeFilter(), TIMERANGEFILTER_BINDING);
        } catch (Exception e) {
