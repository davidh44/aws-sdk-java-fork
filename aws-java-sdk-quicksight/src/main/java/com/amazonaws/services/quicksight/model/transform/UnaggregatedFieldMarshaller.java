...
/**
 * UnaggregatedFieldMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UnaggregatedFieldMarshaller {
    ...
    private static final UnaggregatedFieldMarshaller instance = new UnaggregatedFieldMarshaller();

    public static UnaggregatedFieldMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UnaggregatedField unaggregatedField, ProtocolMarshaller protocolMarshaller) {

        if (unaggregatedField == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(unaggregatedField.getFieldId(), FIELDID_BINDING);
            protocolMarshaller.marshall(unaggregatedField.getColumn(), COLUMN_BINDING);
            protocolMarshaller.marshall(unaggregatedField.getFormatConfiguration(), FORMATCONFIGURATION_BINDING);
        } catch (Exception e) {
