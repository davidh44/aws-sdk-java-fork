 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/FilterTextFieldControl" target="_top">AWS
 *      API Documentation</a>
 */
...
public class FilterTextFieldControl implements Serializable, Cloneable, StructuredPojo {
    ...
    public FilterTextFieldControl withFilterControlId(String filterControlId) {
    ...
    public FilterTextFieldControl withTitle(String title) {
        setTitle(title);
        return this;
    }
    ...
    public FilterTextFieldControl withSourceFilterId(String sourceFilterId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FilterTextFieldControl == false)
            return false;
    ...
    @Override
    public FilterTextFieldControl clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.FilterTextFieldControlMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
