...
/**
 * FilledMapVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FilledMapVisualMarshaller {
    ...
    private static final FilledMapVisualMarshaller instance = new FilledMapVisualMarshaller();

    public static FilledMapVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FilledMapVisual filledMapVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(filledMapVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(filledMapVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(filledMapVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(filledMapVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(filledMapVisual.getConditionalFormatting(), CONDITIONALFORMATTING_BINDING);
            protocolMarshaller.marshall(filledMapVisual.getColumnHierarchies(), COLUMNHIERARCHIES_BINDING);
            protocolMarshaller.marshall(filledMapVisual.getActions(), ACTIONS_BINDING);
        } catch (Exception e) {
