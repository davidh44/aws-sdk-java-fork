...
/**
 * PaginationConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PaginationConfigurationMarshaller {

    private static final MarshallingInfo<Long> PAGESIZE_BINDING = MarshallingInfo.builder(MarshallingType.LONG).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("PageSize").build();
    ...
    public void marshall(PaginationConfiguration paginationConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(paginationConfiguration.getPageSize(), PAGESIZE_BINDING);
            protocolMarshaller.marshall(paginationConfiguration.getPageNumber(), PAGENUMBER_BINDING);
        } catch (Exception e) {
