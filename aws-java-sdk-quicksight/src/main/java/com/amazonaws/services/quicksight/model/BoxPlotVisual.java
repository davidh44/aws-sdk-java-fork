 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/BoxPlotVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BoxPlotVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private BoxPlotChartConfiguration chartConfiguration;
    /**
     * <p>
    ...
    public BoxPlotVisual withVisualId(String visualId) {
    ...
    public BoxPlotVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public BoxPlotVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(BoxPlotChartConfiguration chartConfiguration) {
    ...
    public BoxPlotChartConfiguration getChartConfiguration() {
    ...
    public BoxPlotVisual withChartConfiguration(BoxPlotChartConfiguration chartConfiguration) {
    ...
    public BoxPlotVisual withActions(VisualCustomAction... actions) {
    ...
    public BoxPlotVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public BoxPlotVisual withColumnHierarchies(ColumnHierarchy... columnHierarchies) {
    ...
    public BoxPlotVisual withColumnHierarchies(java.util.Collection<ColumnHierarchy> columnHierarchies) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BoxPlotVisual == false)
            return false;
        BoxPlotVisual other = (BoxPlotVisual) obj;
    ...
    @Override
    public BoxPlotVisual clone() {
        try {
            return (BoxPlotVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.BoxPlotVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
