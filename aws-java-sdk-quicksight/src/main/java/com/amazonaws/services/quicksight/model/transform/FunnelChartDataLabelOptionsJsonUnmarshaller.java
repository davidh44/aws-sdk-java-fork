...
/**
 * FunnelChartDataLabelOptions JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FunnelChartDataLabelOptionsJsonUnmarshaller implements Unmarshaller<FunnelChartDataLabelOptions, JsonUnmarshallerContext> {

    public FunnelChartDataLabelOptions unmarshall(JsonUnmarshallerContext context) throws Exception {
        FunnelChartDataLabelOptions funnelChartDataLabelOptions = new FunnelChartDataLabelOptions();
    ...
    private static FunnelChartDataLabelOptionsJsonUnmarshaller instance;

    public static FunnelChartDataLabelOptionsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FunnelChartDataLabelOptionsJsonUnmarshaller();
        return instance;
    }
}
