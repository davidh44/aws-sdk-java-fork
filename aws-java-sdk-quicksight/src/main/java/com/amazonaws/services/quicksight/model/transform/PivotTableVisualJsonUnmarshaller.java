...
/**
 * PivotTableVisual JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PivotTableVisualJsonUnmarshaller implements Unmarshaller<PivotTableVisual, JsonUnmarshallerContext> {

    public PivotTableVisual unmarshall(JsonUnmarshallerContext context) throws Exception {
        PivotTableVisual pivotTableVisual = new PivotTableVisual();
    ...
    private static PivotTableVisualJsonUnmarshaller instance;

    public static PivotTableVisualJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new PivotTableVisualJsonUnmarshaller();
        return instance;
    }
}
