...
/**
 * Spacing JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SpacingJsonUnmarshaller implements Unmarshaller<Spacing, JsonUnmarshallerContext> {

    public Spacing unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static SpacingJsonUnmarshaller instance;

    public static SpacingJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SpacingJsonUnmarshaller();
        return instance;
    }
}
