 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/WordCloudVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class WordCloudVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private WordCloudChartConfiguration chartConfiguration;
    /**
     * <p>
    ...
    public WordCloudVisual withVisualId(String visualId) {
    ...
    public WordCloudVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public WordCloudVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(WordCloudChartConfiguration chartConfiguration) {
    ...
    public WordCloudChartConfiguration getChartConfiguration() {
    ...
    public WordCloudVisual withChartConfiguration(WordCloudChartConfiguration chartConfiguration) {
    ...
    public WordCloudVisual withActions(VisualCustomAction... actions) {
    ...
    public WordCloudVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public WordCloudVisual withColumnHierarchies(ColumnHierarchy... columnHierarchies) {
    ...
    public WordCloudVisual withColumnHierarchies(java.util.Collection<ColumnHierarchy> columnHierarchies) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof WordCloudVisual == false)
            return false;
        WordCloudVisual other = (WordCloudVisual) obj;
    ...
    @Override
    public WordCloudVisual clone() {
        try {
            return (WordCloudVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.WordCloudVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
