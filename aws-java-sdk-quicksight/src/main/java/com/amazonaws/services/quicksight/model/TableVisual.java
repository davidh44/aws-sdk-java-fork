 ...
 * </p>
 * <p>
 * For more information, see <a href="https://docs.aws.amazon.com/quicksight/latest/user/tabular.html">Using tables as
 * visuals</a> in the <i>Amazon QuickSight User Guide</i>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/TableVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TableVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private TableConditionalFormatting conditionalFormatting;
    /**
     * <p>
    ...
    public TableVisual withVisualId(String visualId) {
    ...
    public TableVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public TableVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(TableConfiguration chartConfiguration) {
    ...
    public TableConfiguration getChartConfiguration() {
    ...
    public TableVisual withChartConfiguration(TableConfiguration chartConfiguration) {
    ...
    public TableVisual withActions(VisualCustomAction... actions) {
    ...
    public TableVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TableVisual == false)
            return false;
        TableVisual other = (TableVisual) obj;
    ...
    @Override
    public TableVisual clone() {
        try {
            return (TableVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.TableVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
