...
/**
 * DateMeasureFieldMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DateMeasureFieldMarshaller {
    ...
    private static final DateMeasureFieldMarshaller instance = new DateMeasureFieldMarshaller();

    public static DateMeasureFieldMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DateMeasureField dateMeasureField, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dateMeasureField.getFieldId(), FIELDID_BINDING);
            protocolMarshaller.marshall(dateMeasureField.getColumn(), COLUMN_BINDING);
            protocolMarshaller.marshall(dateMeasureField.getAggregationFunction(), AGGREGATIONFUNCTION_BINDING);
            protocolMarshaller.marshall(dateMeasureField.getFormatConfiguration(), FORMATCONFIGURATION_BINDING);
        } catch (Exception e) {
