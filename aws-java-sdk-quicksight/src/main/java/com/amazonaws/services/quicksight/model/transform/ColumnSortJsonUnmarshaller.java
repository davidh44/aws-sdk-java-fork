...
/**
 * ColumnSort JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ColumnSortJsonUnmarshaller implements Unmarshaller<ColumnSort, JsonUnmarshallerContext> {

    public ColumnSort unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static ColumnSortJsonUnmarshaller instance;

    public static ColumnSortJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ColumnSortJsonUnmarshaller();
        return instance;
    }
}
