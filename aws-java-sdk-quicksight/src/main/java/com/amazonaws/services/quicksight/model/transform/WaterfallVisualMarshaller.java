...
/**
 * WaterfallVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class WaterfallVisualMarshaller {
    ...
    private static final WaterfallVisualMarshaller instance = new WaterfallVisualMarshaller();

    public static WaterfallVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(WaterfallVisual waterfallVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(waterfallVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(waterfallVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(waterfallVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(waterfallVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(waterfallVisual.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(waterfallVisual.getColumnHierarchies(), COLUMNHIERARCHIES_BINDING);
        } catch (Exception e) {
