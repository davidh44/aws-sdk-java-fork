 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/IntegerValueWhenUnsetConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class IntegerValueWhenUnsetConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public IntegerValueWhenUnsetConfiguration withValueWhenUnsetOption(String valueWhenUnsetOption) {
    ...
    public IntegerValueWhenUnsetConfiguration withValueWhenUnsetOption(ValueWhenUnsetOption valueWhenUnsetOption) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof IntegerValueWhenUnsetConfiguration == false)
            return false;
        IntegerValueWhenUnsetConfiguration other = (IntegerValueWhenUnsetConfiguration) obj;
    ...
    @Override
    public IntegerValueWhenUnsetConfiguration clone() {
        try {
            return (IntegerValueWhenUnsetConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.IntegerValueWhenUnsetConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
