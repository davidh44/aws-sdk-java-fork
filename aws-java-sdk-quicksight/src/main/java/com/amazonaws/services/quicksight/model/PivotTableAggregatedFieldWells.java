 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/PivotTableAggregatedFieldWells"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PivotTableAggregatedFieldWells implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The rows field well for a pivot table. Values are grouped by rows fields.
     */
    ...
    public PivotTableAggregatedFieldWells withRows(DimensionField... rows) {
        if (this.rows == null) {
    ...
    public PivotTableAggregatedFieldWells withRows(java.util.Collection<DimensionField> rows) {
        setRows(rows);
        return this;
    }
     ...
     * </p>
     * 
     * @return The columns field well for a pivot table. Values are grouped by columns fields.
     */
    ...
    public PivotTableAggregatedFieldWells withColumns(DimensionField... columns) {
    ...
    public PivotTableAggregatedFieldWells withColumns(java.util.Collection<DimensionField> columns) {
        setColumns(columns);
        return this;
    }
     ...
     * </p>
     * 
     * @return The values field well for a pivot table. Values are aggregated based on rows and columns fields.
     */
    ...
    public PivotTableAggregatedFieldWells withValues(MeasureField... values) {
        if (this.values == null) {
    ...
    public PivotTableAggregatedFieldWells withValues(java.util.Collection<MeasureField> values) {
        setValues(values);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PivotTableAggregatedFieldWells == false)
            return false;
        PivotTableAggregatedFieldWells other = (PivotTableAggregatedFieldWells) obj;
    ...
    @Override
    public PivotTableAggregatedFieldWells clone() {
        try {
            return (PivotTableAggregatedFieldWells) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.PivotTableAggregatedFieldWellsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
