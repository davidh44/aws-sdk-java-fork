...
/**
 * TableVisual JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TableVisualJsonUnmarshaller implements Unmarshaller<TableVisual, JsonUnmarshallerContext> {

    public TableVisual unmarshall(JsonUnmarshallerContext context) throws Exception {
        TableVisual tableVisual = new TableVisual();
    ...
    private static TableVisualJsonUnmarshaller instance;

    public static TableVisualJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TableVisualJsonUnmarshaller();
        return instance;
    }
}
