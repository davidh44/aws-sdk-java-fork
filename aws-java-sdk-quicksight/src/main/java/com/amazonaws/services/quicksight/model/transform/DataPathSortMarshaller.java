...
public class DataPathSortMarshaller {
    ...
    private static final MarshallingInfo<List> SORTPATHS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("SortPaths").build();
    ...
    public void marshall(DataPathSort dataPathSort, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dataPathSort.getDirection(), DIRECTION_BINDING);
