 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/SankeyDiagramVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SankeyDiagramVisual implements Serializable, Cloneable, StructuredPojo {
    ...
    public SankeyDiagramVisual withVisualId(String visualId) {
    ...
    public SankeyDiagramVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public SankeyDiagramVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(SankeyDiagramChartConfiguration chartConfiguration) {
    ...
    public SankeyDiagramChartConfiguration getChartConfiguration() {
    ...
    public SankeyDiagramVisual withChartConfiguration(SankeyDiagramChartConfiguration chartConfiguration) {
    ...
    public SankeyDiagramVisual withActions(VisualCustomAction... actions) {
    ...
    public SankeyDiagramVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SankeyDiagramVisual == false)
            return false;
    ...
    @Override
    public SankeyDiagramVisual clone() {
        try {
            return (SankeyDiagramVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.SankeyDiagramVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
