...
/**
 * ParameterDropDownControl JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ParameterDropDownControlJsonUnmarshaller implements Unmarshaller<ParameterDropDownControl, JsonUnmarshallerContext> {

    public ParameterDropDownControl unmarshall(JsonUnmarshallerContext context) throws Exception {
        ParameterDropDownControl parameterDropDownControl = new ParameterDropDownControl();
    ...
    private static ParameterDropDownControlJsonUnmarshaller instance;

    public static ParameterDropDownControlJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ParameterDropDownControlJsonUnmarshaller();
        return instance;
    }
}
