 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/PieChartAggregatedFieldWells"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PieChartAggregatedFieldWells implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The category (group/color) field wells of a pie chart.
     */
    ...
    public PieChartAggregatedFieldWells withCategory(DimensionField... category) {
    ...
    public PieChartAggregatedFieldWells withCategory(java.util.Collection<DimensionField> category) {
     ...
     * </p>
     * 
     * @return The value field wells of a pie chart. Values are aggregated based on categories.
     */
    ...
    public PieChartAggregatedFieldWells withValues(MeasureField... values) {
        if (this.values == null) {
    ...
    public PieChartAggregatedFieldWells withValues(java.util.Collection<MeasureField> values) {
        setValues(values);
        return this;
    }
     ...
     * </p>
     * 
     * @return The small multiples field well of a pie chart.
     */
    ...
    public PieChartAggregatedFieldWells withSmallMultiples(DimensionField... smallMultiples) {
    ...
    public PieChartAggregatedFieldWells withSmallMultiples(java.util.Collection<DimensionField> smallMultiples) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PieChartAggregatedFieldWells == false)
            return false;
        PieChartAggregatedFieldWells other = (PieChartAggregatedFieldWells) obj;
    ...
    @Override
    public PieChartAggregatedFieldWells clone() {
        try {
            return (PieChartAggregatedFieldWells) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.PieChartAggregatedFieldWellsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
