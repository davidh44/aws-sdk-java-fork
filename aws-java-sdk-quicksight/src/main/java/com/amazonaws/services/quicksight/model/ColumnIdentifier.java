 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/ColumnIdentifier" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ColumnIdentifier implements Serializable, Cloneable, StructuredPojo {
    ...
    public ColumnIdentifier withDataSetIdentifier(String dataSetIdentifier) {
    ...
    public ColumnIdentifier withColumnName(String columnName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ColumnIdentifier == false)
            return false;
    ...
    public ColumnIdentifier clone() {
        try {
            return (ColumnIdentifier) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.ColumnIdentifierMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
