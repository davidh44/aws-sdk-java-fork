 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/DateTimeDefaultValues" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DateTimeDefaultValues implements Serializable, Cloneable, StructuredPojo {
    ...
    public DateTimeDefaultValues withStaticValues(java.util.Date... staticValues) {
    ...
    public DateTimeDefaultValues withStaticValues(java.util.Collection<java.util.Date> staticValues) {
     ...
     * 
     * @param rollingDate
     *        The rolling date of the <code>DataTimeDefaultValues</code>. The date is determined from the dataset based
     *        on input expression.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DateTimeDefaultValues == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.DateTimeDefaultValuesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
