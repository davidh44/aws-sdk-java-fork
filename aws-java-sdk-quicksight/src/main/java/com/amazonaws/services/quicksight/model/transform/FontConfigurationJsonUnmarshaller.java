...
/**
 * FontConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FontConfigurationJsonUnmarshaller implements Unmarshaller<FontConfiguration, JsonUnmarshallerContext> {

    public FontConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static FontConfigurationJsonUnmarshaller instance;

    public static FontConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FontConfigurationJsonUnmarshaller();
        return instance;
    }
}
