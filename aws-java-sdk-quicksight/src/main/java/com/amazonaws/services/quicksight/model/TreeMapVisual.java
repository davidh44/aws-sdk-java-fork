 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/TreeMapVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TreeMapVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private TreeMapConfiguration chartConfiguration;
    /**
     * <p>
    ...
    public TreeMapVisual withVisualId(String visualId) {
    ...
    public TreeMapVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public TreeMapVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(TreeMapConfiguration chartConfiguration) {
    ...
    public TreeMapConfiguration getChartConfiguration() {
    ...
    public TreeMapVisual withChartConfiguration(TreeMapConfiguration chartConfiguration) {
    ...
    public TreeMapVisual withActions(VisualCustomAction... actions) {
    ...
    public TreeMapVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public TreeMapVisual withColumnHierarchies(ColumnHierarchy... columnHierarchies) {
    ...
    public TreeMapVisual withColumnHierarchies(java.util.Collection<ColumnHierarchy> columnHierarchies) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TreeMapVisual == false)
            return false;
        TreeMapVisual other = (TreeMapVisual) obj;
    ...
    @Override
    public TreeMapVisual clone() {
        try {
            return (TreeMapVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.TreeMapVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
