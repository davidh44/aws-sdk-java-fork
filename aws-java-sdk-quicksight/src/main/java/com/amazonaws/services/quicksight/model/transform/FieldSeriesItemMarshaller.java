...
/**
 * FieldSeriesItemMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class FieldSeriesItemMarshaller {
    ...
    private static final FieldSeriesItemMarshaller instance = new FieldSeriesItemMarshaller();

    public static FieldSeriesItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(FieldSeriesItem fieldSeriesItem, ProtocolMarshaller protocolMarshaller) {

        if (fieldSeriesItem == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(fieldSeriesItem.getFieldId(), FIELDID_BINDING);
            protocolMarshaller.marshall(fieldSeriesItem.getAxisBinding(), AXISBINDING_BINDING);
            protocolMarshaller.marshall(fieldSeriesItem.getSettings(), SETTINGS_BINDING);
        } catch (Exception e) {
