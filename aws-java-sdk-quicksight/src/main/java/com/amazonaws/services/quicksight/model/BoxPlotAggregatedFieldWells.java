 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/BoxPlotAggregatedFieldWells"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BoxPlotAggregatedFieldWells implements Serializable, Cloneable, StructuredPojo {
    ...
    public BoxPlotAggregatedFieldWells withGroupBy(DimensionField... groupBy) {
    ...
    public BoxPlotAggregatedFieldWells withGroupBy(java.util.Collection<DimensionField> groupBy) {
        setGroupBy(groupBy);
        return this;
    }
    ...
    public BoxPlotAggregatedFieldWells withValues(MeasureField... values) {
        if (this.values == null) {
    ...
    public BoxPlotAggregatedFieldWells withValues(java.util.Collection<MeasureField> values) {
        setValues(values);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BoxPlotAggregatedFieldWells == false)
            return false;
    ...
    @Override
    public BoxPlotAggregatedFieldWells clone() {
        try {
            return (BoxPlotAggregatedFieldWells) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.BoxPlotAggregatedFieldWellsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
