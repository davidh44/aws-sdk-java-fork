...
/**
 * PivotTableCellConditionalFormattingMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PivotTableCellConditionalFormattingMarshaller {
    ...
    public static PivotTableCellConditionalFormattingMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PivotTableCellConditionalFormatting pivotTableCellConditionalFormatting, ProtocolMarshaller protocolMarshaller) {

        if (pivotTableCellConditionalFormatting == null) {
