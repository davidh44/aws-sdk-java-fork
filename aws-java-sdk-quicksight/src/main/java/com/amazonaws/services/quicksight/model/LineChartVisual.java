 ...
 * </p>
 * <p>
 * For more information, see <a href="https://docs.aws.amazon.com/quicksight/latest/user/line-charts.html">Using line
 * charts</a> in the <i>Amazon QuickSight User Guide</i>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/LineChartVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LineChartVisual implements Serializable, Cloneable, StructuredPojo {
    ...
    public LineChartVisual withVisualId(String visualId) {
    ...
    public LineChartVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public LineChartVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(LineChartConfiguration chartConfiguration) {
     ...
     * </p>
     * 
     * @return The configuration of a line chart.
     */

    public LineChartConfiguration getChartConfiguration() {
    ...
    public LineChartVisual withChartConfiguration(LineChartConfiguration chartConfiguration) {
    ...
    public LineChartVisual withActions(VisualCustomAction... actions) {
    ...
    public LineChartVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public LineChartVisual withColumnHierarchies(ColumnHierarchy... columnHierarchies) {
    ...
    public LineChartVisual withColumnHierarchies(java.util.Collection<ColumnHierarchy> columnHierarchies) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LineChartVisual == false)
            return false;
        LineChartVisual other = (LineChartVisual) obj;
    ...
    @Override
    public LineChartVisual clone() {
        try {
            return (LineChartVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.LineChartVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
