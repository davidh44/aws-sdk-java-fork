 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/UnaggregatedField" target="_top">AWS API
 *      Documentation</a>
 */
...
public class UnaggregatedField implements Serializable, Cloneable, StructuredPojo {
    ...
    public UnaggregatedField withColumn(ColumnIdentifier column) {
        setColumn(column);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UnaggregatedField == false)
            return false;
    ...
    @Override
    public UnaggregatedField clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.UnaggregatedFieldMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
