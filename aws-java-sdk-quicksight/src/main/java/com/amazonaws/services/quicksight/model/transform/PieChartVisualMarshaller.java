...
/**
 * PieChartVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class PieChartVisualMarshaller {
    ...
    private static final PieChartVisualMarshaller instance = new PieChartVisualMarshaller();

    public static PieChartVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PieChartVisual pieChartVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(pieChartVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(pieChartVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(pieChartVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(pieChartVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(pieChartVisual.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(pieChartVisual.getColumnHierarchies(), COLUMNHIERARCHIES_BINDING);
        } catch (Exception e) {
