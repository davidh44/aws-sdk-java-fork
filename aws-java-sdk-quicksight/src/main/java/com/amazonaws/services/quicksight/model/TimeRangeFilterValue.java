 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/TimeRangeFilterValue" target="_top">AWS
 *      API Documentation</a>
 */
...
public class TimeRangeFilterValue implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private java.util.Date staticValue;
    /**
     * <p>
    ...
    public void setStaticValue(java.util.Date staticValue) {
    ...
    public java.util.Date getStaticValue() {
    ...
    public TimeRangeFilterValue withStaticValue(java.util.Date staticValue) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TimeRangeFilterValue == false)
            return false;
    ...
    @Override
    public TimeRangeFilterValue clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.TimeRangeFilterValueMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
