...
/**
 * FilterGroup JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FilterGroupJsonUnmarshaller implements Unmarshaller<FilterGroup, JsonUnmarshallerContext> {

    public FilterGroup unmarshall(JsonUnmarshallerContext context) throws Exception {
    ...
    private static FilterGroupJsonUnmarshaller instance;

    public static FilterGroupJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new FilterGroupJsonUnmarshaller();
        return instance;
    }
}
