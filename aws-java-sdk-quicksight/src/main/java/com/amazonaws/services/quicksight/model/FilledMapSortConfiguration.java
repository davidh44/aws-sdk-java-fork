 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/FilledMapSortConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class FilledMapSortConfiguration implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The sort configuration of the location fields.
     */
    ...
    public FilledMapSortConfiguration withCategorySort(FieldSortOptions... categorySort) {
    ...
    public FilledMapSortConfiguration withCategorySort(java.util.Collection<FieldSortOptions> categorySort) {
    ...
    public String toString() {
        ...
        if (getCategorySort() != null)
            sb.append("CategorySort: ").append(getCategorySort());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FilledMapSortConfiguration == false)
            return false;
        FilledMapSortConfiguration other = (FilledMapSortConfiguration) obj;
    ...
    @Override
    public FilledMapSortConfiguration clone() {
        try {
            return (FilledMapSortConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.FilledMapSortConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
