 ...
 * </p>
 * <p>
 * For more information, see <a href="https://docs.aws.amazon.com/quicksight/latest/user/point-maps.html">Creating point
 * maps</a> in the <i>Amazon QuickSight User Guide</i>.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/GeospatialMapVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GeospatialMapVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private GeospatialMapConfiguration chartConfiguration;
    /**
     * <p>
    ...
    public GeospatialMapVisual withVisualId(String visualId) {
    ...
    public GeospatialMapVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public GeospatialMapVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(GeospatialMapConfiguration chartConfiguration) {
    ...
    public GeospatialMapConfiguration getChartConfiguration() {
    ...
    public GeospatialMapVisual withChartConfiguration(GeospatialMapConfiguration chartConfiguration) {
    ...
    public GeospatialMapVisual withColumnHierarchies(ColumnHierarchy... columnHierarchies) {
    ...
    public GeospatialMapVisual withColumnHierarchies(java.util.Collection<ColumnHierarchy> columnHierarchies) {
    ...
    public GeospatialMapVisual withActions(VisualCustomAction... actions) {
    ...
    public GeospatialMapVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GeospatialMapVisual == false)
            return false;
        GeospatialMapVisual other = (GeospatialMapVisual) obj;
    ...
    @Override
    public GeospatialMapVisual clone() {
        try {
            return (GeospatialMapVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.GeospatialMapVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
