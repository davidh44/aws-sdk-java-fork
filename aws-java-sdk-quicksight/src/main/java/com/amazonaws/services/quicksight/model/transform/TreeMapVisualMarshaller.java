...
/**
 * TreeMapVisualMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class TreeMapVisualMarshaller {
    ...
    private static final TreeMapVisualMarshaller instance = new TreeMapVisualMarshaller();

    public static TreeMapVisualMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(TreeMapVisual treeMapVisual, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(treeMapVisual.getVisualId(), VISUALID_BINDING);
            protocolMarshaller.marshall(treeMapVisual.getTitle(), TITLE_BINDING);
            protocolMarshaller.marshall(treeMapVisual.getSubtitle(), SUBTITLE_BINDING);
            protocolMarshaller.marshall(treeMapVisual.getChartConfiguration(), CHARTCONFIGURATION_BINDING);
            protocolMarshaller.marshall(treeMapVisual.getActions(), ACTIONS_BINDING);
            protocolMarshaller.marshall(treeMapVisual.getColumnHierarchies(), COLUMNHIERARCHIES_BINDING);
        } catch (Exception e) {
