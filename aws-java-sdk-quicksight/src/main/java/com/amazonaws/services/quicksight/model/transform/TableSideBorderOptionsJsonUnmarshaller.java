...
/**
 * TableSideBorderOptions JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TableSideBorderOptionsJsonUnmarshaller implements Unmarshaller<TableSideBorderOptions, JsonUnmarshallerContext> {

    public TableSideBorderOptions unmarshall(JsonUnmarshallerContext context) throws Exception {
        TableSideBorderOptions tableSideBorderOptions = new TableSideBorderOptions();
    ...
    private static TableSideBorderOptionsJsonUnmarshaller instance;

    public static TableSideBorderOptionsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TableSideBorderOptionsJsonUnmarshaller();
        return instance;
    }
}
