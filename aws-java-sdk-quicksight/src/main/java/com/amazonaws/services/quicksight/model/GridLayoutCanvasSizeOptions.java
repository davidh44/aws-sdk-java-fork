 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/GridLayoutCanvasSizeOptions"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GridLayoutCanvasSizeOptions implements Serializable, Cloneable, StructuredPojo {
    ...
    public GridLayoutScreenCanvasSizeOptions getScreenCanvasSizeOptions() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GridLayoutCanvasSizeOptions == false)
            return false;
    ...
    public GridLayoutCanvasSizeOptions clone() {
        try {
            return (GridLayoutCanvasSizeOptions) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.GridLayoutCanvasSizeOptionsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
