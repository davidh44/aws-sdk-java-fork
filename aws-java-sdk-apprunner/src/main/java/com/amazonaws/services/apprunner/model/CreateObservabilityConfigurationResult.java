...
public class CreateObservabilityConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return A description of the App Runner observability configuration that's created by this request.
     */
    ...
    public CreateObservabilityConfigurationResult withObservabilityConfiguration(ObservabilityConfiguration observabilityConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateObservabilityConfigurationResult == false)
            return false;
        CreateObservabilityConfigurationResult other = (CreateObservabilityConfigurationResult) obj;
    ...
    @Override
    public CreateObservabilityConfigurationResult clone() {
        try {
            return (CreateObservabilityConfigurationResult) super.clone();
