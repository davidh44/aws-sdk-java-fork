...
/**
 * ObservabilityConfiguration JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ObservabilityConfigurationJsonUnmarshaller implements Unmarshaller<ObservabilityConfiguration, JsonUnmarshallerContext> {

    public ObservabilityConfiguration unmarshall(JsonUnmarshallerContext context) throws Exception {
        ObservabilityConfiguration observabilityConfiguration = new ObservabilityConfiguration();
    ...
    private static ObservabilityConfigurationJsonUnmarshaller instance;

    public static ObservabilityConfigurationJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new ObservabilityConfigurationJsonUnmarshaller();
        return instance;
    }
}
