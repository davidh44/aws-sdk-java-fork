...
public class ListObservabilityConfigurationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListObservabilityConfigurationsRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListObservabilityConfigurationsRequest == false)
            return false;
    ...
    @Override
    public ListObservabilityConfigurationsRequest clone() {
        return (ListObservabilityConfigurationsRequest) super.clone();
    }
