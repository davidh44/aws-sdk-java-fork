 ...
 * </p>
 * <p>
 * You need to provide the file system ID and the pathname. The pathname can represent either a path or a file. This is
 * determined by whether or not you end the path value with the forward slash (/) character. If the final character is
 * "/", then your file is copied to the folder, and its name does not change. If, rather, the final character is
 * alphanumeric, your uploaded file is renamed to the path value. In this case, if a file with that name already exists,
 * it is overwritten.
 * </p>
 * <p>
