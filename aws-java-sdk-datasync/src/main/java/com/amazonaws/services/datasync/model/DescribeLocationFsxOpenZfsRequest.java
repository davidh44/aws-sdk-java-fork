...
public class DescribeLocationFsxOpenZfsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the FSx for OpenZFS location to describe.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeLocationFsxOpenZfsRequest == false)
            return false;
        DescribeLocationFsxOpenZfsRequest other = (DescribeLocationFsxOpenZfsRequest) obj;
    ...
    public DescribeLocationFsxOpenZfsRequest clone() {
        return (DescribeLocationFsxOpenZfsRequest) super.clone();
    }
